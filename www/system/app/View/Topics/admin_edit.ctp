<div class="row-fluid">
	<div class="span9">
		<?php echo $this->BootstrapForm->create('Topic', array('class' => 'form-horizontal' , 'inputDefaults' => array(
        'empty' => 'なし'
    )));?>
			<fieldset>
				...
				<legend><?php echo __('Admin Edit %s', __('Topic')); ?></legend>
				<?php
				...
				echo $this->BootstrapForm->input('created');
				echo $this->BootstrapForm->input('modified');
