<div class="row-fluid" style="width:135%">
	<div class="span9">
		<legend><?php  echo __('Topic');?></legend>
		<dl>
			...
			<dd>
				<?php echo $this->Html->link($topic['Category']['category_name'], array('controller' => 'categories', 'action' => 'view', $topic['Category']['id'])); ?>
				&nbsp;
			</dd>
			<dt><?php echo __('Tag'); ?></dt>
			<dd>
				<?php echo $this->Html->link($topic['Tag']['word'], array('controller' => 'tags', 'action' => 'view', $topic['Tag']['id'])); ?>
				&nbsp;
			</dd>
			...
			<dd>
				<?php echo h($topic['Topic']['file_name1']); ?>
				&nbsp;
			</dd>
			<dt><?php echo __('File Name2'); ?></dt>
			<dd>
				<?php echo h($topic['Topic']['file_name2']); ?>
				&nbsp;
			</dd>
