	...
	<table cellpadding="0" cellspacing="0" summary="ユーザー情報">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?php echo $this->Form->input('User.email', array('class'=>'femail')); ?>
				</td>
				<td>※非公開</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<ul class="photo clearfix">
					...
					<li class='image-box'>
						...
						?>
						<img src="<?php echo $img; ?>" width="70" alt="">
					</li>
					<li class='delete_image' <?php if(empty($img)): ?>style='display:none'<?php endif; ?>>
						<img src="/img/mypage/link12.jpg" width="26" height="23" alt="削除" class='delete_chk'>
			...
			<tr>
				...
				<td>
				<div style='margin-left:-5px;'>
				<?php echo $this->Form->input('pv_address', array('type'=>'radio', 'label'=>true, 'options'=>array('1'=>' 公開', '0'=>' 非公開'), 'default'=>0, 'separator'=>'　')); ?>
				</div>
				</td>
			</tr>
			<tr>
...
<ul class="linkList clearfix">
	<li>
		<a href="/mypage/users/invite" class='fancybox fancybox.iframe'><img src="/img/mypage/link10.jpg" width="222" height="33" alt="パートナー・親族を招待"></a>
	</li>
	<li class="floatR">
