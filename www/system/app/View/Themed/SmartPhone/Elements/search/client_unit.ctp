						...
						<tr>
							...
							<div class="inner clearfix">
									<div class="photoBox_graphbox">
										...
										?>
									<div class="photoBox_graph1"><img src="/img/search/imgtext08.gif" width="<?php echo $w['1'];?>" height="15" alt="" />
                                                                 
                                    </div>
                  <div class="photoBox_graph2"><img src="/img/search/imgtext08.gif" width="<?php echo $w['2'];?>" height="15" alt="" />
                                               
                                    </div>
                  <div class="photoBox_graph3"><img src="/img/search/imgtext08.gif" width="<?php echo $w['3'];?>" height="15" alt="" />
                                    </div>
									...
									<div class="textBox">
										...
										<ul class="clearfix">
											<li><span>行ってみたい</span><span class="color"><?php echo (!is_null($client['ClientPoll']['n1']))?@h($client['ClientPoll']['n1'])+0:'-'; ?></span>件</li>
											<li><span>また行きたい</span><span class="color"><?php echo (!is_null($client['ClientPoll']['n2']))?@h($client['ClientPoll']['n2'])+0:'-'; ?></span>件</li>
											<li><span>もう十分</span><span class="color"><?php echo (!is_null($client['ClientPoll']['n3']))?@h($client['ClientPoll']['n3'])+0:'-'; ?></span>件</li>
										</ul>
									</div>
								</div>
								<p class="pText clearfix"><span>コメント：<span class="colorBg"><?php echo ($client['Client']['num_comments'])?$client['Client']['num_comments']:'-';?></span>件</span><span class="widthTd">お気に入り：<span class="colorBg colorBg01"><?php echo ($client['Client']['num_likes'])?$client['Client']['num_likes']:'-';?></span>件</span></p>
							</td>
						</tr>
						<!-- unit end -->