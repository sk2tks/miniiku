...
<div class="popBox">
	...
	<div class="popup">
		<h1>メール送信完了</h1>
		<p style='text-align:left;'>本登録用のURLをお送りしました。メールのご確認をお願い致します。</p>
		<p style='color:#C00; text-align:left; margin-bottom:15px;'>※迷惑メールとして分類されているケースも確認されております。</p>
		<p style='color:#C00; text-align:left; margin-bottom:15px;'>※１時間経過してもメールが届かない場合は、お問合せフォームよりご連絡下さい。</p>
		<div class="popInner" style='text-align:center;'>
